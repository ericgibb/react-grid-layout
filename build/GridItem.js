...
var GridItem = function (_React$Component) {
  ...
  function GridItem() {
    ...
    return _ret = (_temp = (_this = _possibleConstructorReturn(this, _React$Component.call.apply(_React$Component, [this].concat(args))), _this), _this.state = {
      ...
      className: ''
    }, _this.startDrag = function (node, draggingPosition) {
      var nodeBounds = node.getBoundingClientRect();
      var newDownEvent = new MouseEvent('mousedown', {
        target: node,
    ...
    }, _this.collide = function (node, sectionBound) {
      return !(node.top > sectionBound.bottom || node.right < sectionBound.left || node.bottom < sectionBound.top || node.left > sectionBound.right);
  ...
  GridItem.prototype.componentDidUpdate = function componentDidUpdate(prevProps, prevState) {

    if (this.props.drag && !prevState.dragging) {
      this.startDrag((0, _reactDom.findDOMNode)(this), this.props.dragPosition);
    }
  };
  ...
  GridItem.prototype.onDragHandler = function onDragHandler(handlerName) {
    ...
    return function (e, _ref2) {
      ...
      var sectionsBounds = Object.keys(_this2.props.sectionsBounds).filter(function (sectionKey) {
        return sectionKey !== _this2.props.section;
      });
      // Get new XY
      switch (handlerName) {
        case 'onDragStart':
        ...
        case 'onDrag':
          ...
          sectionsBounds.forEach(function (sectionBoundKey) {
            var sectionBound = _this2.props.sectionsBounds[sectionBoundKey];
            if (_this2.collide(nodeRect, sectionBound)) {
              _this2.setState({
      ...
      if (handlerName === 'onDrag') {
        ...
        if (_this2.state.sectionKey) {
          var cacheSectionKey = _this2.state.sectionKey;
          _this2.setState({
            sectionKey: null
          }, function () {
            _this2.props[handlerName](_this2.props.i, x, y, { e: e, node: node, newPosition: newPosition });
            _this2.props.onChangeSection(_this2.props.i, _this2.props.section, cacheSectionKey, _this2.state.mouseOffset);
          });
        } else {
