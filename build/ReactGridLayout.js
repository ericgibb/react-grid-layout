...
var ReactGridLayout = function (_React$Component) {
  ...
  ReactGridLayout.prototype.onDragStop = function onDragStop(i, x, y, _ref3) {
    ...
    var e = _ref3.e,
        node = _ref3.node;
    var resetItems = arguments.length > 4 && arguments[4] !== undefined ? arguments[4] : false;
    var oldDragItem = this.state.oldDragItem;
    var layout = this.state.layout;
    ...
    if (resetItems) {
      newLayout = (0, _utils.resetLayoutItems)(newLayout);
    }
    ...
    this.setState({
      ...
      _this2.props.onDragStop(layout, oldDragItem, l, null, e, node);
    });
  ...
  ReactGridLayout.prototype.processGridItem = function processGridItem(child) {
    ...
    var _props2 = this.props,
        ...
        sectionsBounds = _props2.sectionsBounds,
...
ReactGridLayout.propTypes = {
  ...
  onChangeSection: _react.PropTypes.func,
